...
$sfx_query = "SELECT DISTINCT KB_T.Target_id, KB_OP.OP_ID, KB_TS.TARGET_SERVICE_ID, KB_T.Target_Name, 
    KB_T.TARGET_PUBLIC_NAME, KB_TS.SERVICE_TYPE, L_OPI.LAST_UPDATE_DATE,
    L_OPI.Activation_Status, KB_OP.Threshold Threshold, 
    L_OPLI.Threshold LCL_Threshold
...
WHERE KB_TS.TARGET_ID=KB_T.TARGET_ID AND 
 	( KB_T.TARGET_ID IN (SELECT TARGET_ID FROM sfxglb41.KB_OBJECT_PORTFOLIOS KB_OP WHERE OBJECT_ID>'954921334033' and OBJECT_ID<='954921338033') 	
		AND L_OPI.OP_ID IN (SELECT OP_ID FROM sfxglb41.KB_OBJECT_PORTFOLIOS KB_OP  WHERE OBJECT_ID>'954921334033' and OBJECT_ID<='954921338033')
